      ...
      <div className='mx-auto container px-4 py-8 h-full'>
        ...
        {trailers.length > 0 && (
            <div className='flex justify-between items-center mb-4'>
                <button className={`
                     bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 ml-10 rounded ${currentTrailerIdx === 0 ? 
                ...
                <button className={`
                     bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 mr-10 rounded ${currentTrailerIdx === trailers.length - 1 ? 
                        'cursor-not-allowed opacity-50' : ""}  
        ...
        {similarContent.length > 0 && (
            <div className='mt-12 max-w-5xl mx-auto relative'>
                ...
                <ChevronRight
                    ...
                    opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-red-600
